...
private:
	...
	PushBackListHead(CLinkBuff** listp,CLinkBuff* buff)	;
...
class CConnectionElement : public CGListElement<CConnection,CConnectionElement>
{
public:

};
class CConnectionList : public CGList<CConnectionElement,CConnection>
{
